...
regression (lower MRE is better). The magnitude figures are one protocol (the deep-representation
comparison, seeds shown); the network's roughly threefold advantage over linear is the robust finding,
